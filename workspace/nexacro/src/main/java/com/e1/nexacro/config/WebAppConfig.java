...
@ComponentScan(
	basePackages= {
		"com.e1.nexacro.config",
		"com.e1.nexacro.controller",
		"com.e1.nexacro.service",
		"com.e1.nexacro.model",
	})

@MapperScan(basePackages= {
	"com.e1.nexacro.mapper"
})
...
public class WebAppConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/_theme_/**").addResourceLocations("classpath:/static/testProject/_theme_/");
