(function()
{
    return function()
    {
        ...
        this.loadTypedefition = function()
        {
            ...
            this._addService("default_typedef.xml", "Main", "form", "./Main/", "", null, "", "", "0");
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            var frame1 = new ChildFrame("ChildFrame0", "absolute", null, null, null, null, null, null, "Main::test1.xfdl", frame0);
            frame0.addChild(frame1.name, frame1);
            frame1.set_formurl("Main::test1.xfdl");
            frame1.set_showcascadetitletext("true");
            frame1.set_resizable("false");
